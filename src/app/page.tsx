  ...
  return (
    <div className="min-h-screen bg-[#0B0B0F] text-foreground relative overflow-hidden">
      ...
      <main className="relative z-10">
        ...
        <section id="how-it-works" className="px-6 py-32 max-w-6xl mx-auto bg-gradient-to-b from-purple-950/20 to-transparent">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            ...
            {[
              {
                ...
                desc: "Describe your payment flow in plain language. One-time payments, subscriptions, or usage-based billing."
              },
              {
                step: "02",
                title: "Bloxs generates the code",
                desc: "Pre-configured checkout pages, webhooks, and subscription logic appear in your project ready to use."
              },
              {
                step: "03",
                title: "Go live and get paid",
                desc: "Deploy with confidence. Tax compliance, legal requirements, and analytics are handled automatically."
              }
            ].map((item, i) => (
              <motion.div
                key={i}
