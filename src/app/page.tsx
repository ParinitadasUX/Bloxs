            ...
            <motion.div
              ...
              transition={{ duration: 0.5, delay: i * 0.1 }}>
                <div>
                  ...
                  <h3 className="font-normal text-lg mb-3 text-white !whitespace-pre-line !whitespace-pre-line !whitespace-pre-line">{feature.title}</h3>
                  <p className="text-gray-400 text-sm leading-relaxed !whitespace-pre-line !whitespace-pre-line">{feature.desc}</p>
                </div>
              </motion.div>
            )}
          </div>
